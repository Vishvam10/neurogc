...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket) -> None:
        ...
        print(
            f"[MetricsServer] Client connected. Total connections: {len(self.active_connections)}"
        )
    ...
    def disconnect(self, websocket: WebSocket) -> None:
        ...
        print(
            f"[MetricsServer] Client disconnected. Total connections: {len(self.active_connections)}"
        )
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        await websocket.send_json(
            {"type": "initial", "data": metrics_store.get_history(60), "config": config}
        )
            ...
            try:
                ...
                try:
                    ...
                    if message.get("type") == "get_history":
                        ...
                        await websocket.send_json(
                            {"type": "history", "data": metrics_store.get_history(limit)}
                        )
